function [fa, md, rd, ad, cl, volume, TractProfile,SuperFibersGroup,fgResampled] = babyAFQ_ComputeTractPropertiesNanMean(fg_classified,dt,numberOfNodes,clip2rois,subDir, roiDir, fgnum, weighting, afq)
...
%     end
    ...
    %try
        [fa(:, jj),md(:, jj),rd(:, jj),ad(:, jj),cl(:, jj),...
            ...
            babyFatDtiComputeDiffusionPropertiesAlongFG(fgtmp, dt, roi1, roi2, numberOfNodes,weighting);
