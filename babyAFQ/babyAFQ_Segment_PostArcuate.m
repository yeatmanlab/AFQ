function [L_FG, R_FG, L_roi_1, L_roi_2, R_roi_1, R_roi_2] = babyAFQ_Segment_PostArcuate(dt, wholebrainFG, varargin)

%%%%%%%%%%%%%%%%%%%%
% This is an infant implementation of AFQ_Segment_PostArcuate
...
% [~, ~, L_roi_2]=babyFatDtiCreateRoiFromMniNifti(dt.dataFile, L_roi_2, invDef, 1);
% [~, ~, R_roi_2]=babyFatDtiCreateRoiFromMniNifti(dt.dataFile, R_roi_2, invDef, 1);
% Name the ROIs
...
[L_roi_not, L_roi_1] = babyAFQ_LoadROIs(19,sub_dir,[],fullfile(sub_dir,'babyAFQROIs'));
[R_roi_not, R_roi_1] = babyAFQ_LoadROIs(20,sub_dir,[],fullfile(sub_dir,'babyAFQROIs'));
[L_roiNotUsed, L_roi_2] = babyAFQ_LoadROIs(23,sub_dir,[],fullfile(sub_dir,'babyAFQROIs'));
[R_roiNotUsed, R_roi_2] = babyAFQ_LoadROIs(24,sub_dir,[],fullfile(sub_dir,'babyAFQROIs'));
...
if saveFiles == 1
    ...
    %dtiWriteRoi(L_roi_2,fullfile(sub_dir,'babyAFQROIs',L_roi_2.name));
    %dtiWriteRoi(R_roi_2,fullfile(sub_dir,'babyAFQROIs',R_roi_2.name));
end
