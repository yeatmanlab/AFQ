function [fa, md, rd, ad, cl, volume, TractProfile] = cp_AFQ_ComputeTractProperties(fg_classified,dt,numberOfNodes,clip2rois,subDir, weighting, afq)
...
for jj=1:numfg
    ...
    try
        [fa(:, jj),md(:, jj),rd(:, jj),ad(:, jj),cl(:, jj),...
            ...
            cp_dtiComputeDiffusionPropertiesAlongFG(fgtmp, dt, roi1, roi2, numberOfNodes,weighting);
